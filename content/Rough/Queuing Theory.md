...
#### Introduction
- More demand for service than there is facility for service
- Abstract the problems and solving the abstract model using queuing theory
- Through this limitations can be removed partially (there is still a queuing delay)

**Arrival patterns of customers**
Process of arrival is stochastic. 
...
**Queue Discipline**
The manner in which customers are selected for service (FCFS, LCFS)
A variety of priority schemes. (Preemptive, Non-Preemptive)
**System Capacity**
